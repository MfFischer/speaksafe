    ...
    <div className="space-y-8">
      ...
      >
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600/20 to-blue-600/20 px-4 py-2 rounded-full border border-purple-500/30 mb-6">
          ...
          <span className="text-purple-300 font-medium">Community Powered</span>
        </div>
      ...
      <motion.div
        ...
        className="glass-card p-8 text-center bg-gradient-to-r from-purple-600/10 to-blue-600/10 border-purple-500/30"
      >
